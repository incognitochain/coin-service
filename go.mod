...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20230713024325-bb85d83f8e6f
	...
	github.com/incognitochain/incognito-chain v0.0.0-20230719010425-d736c9a9ac8e
