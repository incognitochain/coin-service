...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20221102051209-7c3b1f69edf3
	...
	github.com/incognitochain/incognito-chain v0.0.0-20221108095729-a4e8817c7210
