...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20220407090503-365abb653f5d
	...
	github.com/incognitochain/incognito-chain v0.0.0-20220426150047-3011332f2b3f
