...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20220113151325-22ee45bf9966
	...
	github.com/incognitochain/incognito-chain v0.0.0-20220113043331-8da1c680d808
