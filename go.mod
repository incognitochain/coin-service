...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211128100827-0441ab170e8b
	...
	github.com/incognitochain/incognito-chain v0.0.0-20211130021758-542a1e00369a
