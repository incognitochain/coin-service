...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211028070758-757779365ae1
	...
	github.com/incognitochain/incognito-chain v0.0.0-20211103013103-20108e1c9b5e
