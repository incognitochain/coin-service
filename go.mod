...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20220405020416-1e7e56d53697
	...
	github.com/incognitochain/incognito-chain v0.0.0-20220405031736-15a223c6886a
