...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211015090505-3f75dab7aeec
	...
	github.com/incognitochain/incognito-chain v0.0.0-20211024150136-e0ed09480d7c
