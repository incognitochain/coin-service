...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211109015858-a6a327d79d5a
	...
	github.com/incognitochain/incognito-chain v0.0.0-20211110045934-f8bfac1efcb1
