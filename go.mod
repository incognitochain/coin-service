...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20220607022555-63ad13bdfa45
	...
	github.com/incognitochain/incognito-chain v0.0.0-20220628091354-fbea4d57c6fa
