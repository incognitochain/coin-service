...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211208023608-4f0f1e8784b6
	...
	github.com/incognitochain/incognito-chain v0.0.0-20211210034835-d7cd1376d635
