...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20211229035717-aed32e32d180
	...
	github.com/incognitochain/incognito-chain v0.0.0-20220104013301-a967c0284ea7
