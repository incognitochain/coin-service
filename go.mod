...
require (
	github.com/0xkumi/incognito-dev-framework v0.0.0-20221206134609-50faf4b33a82
	...
	github.com/incognitochain/incognito-chain v0.0.0-20221227035607-185e5adf1af1
