...
func startProcessHistory() {
	...
	for {
		...
		request, respond, withdrawReq, withdrawRes, err := processTradeOrder(txList)
		if err != nil {
			panic(err)
		}
...
func processTradeOrder(txlist []shared.TxData) ([]shared.TradeOrderData, []shared.TradeOrderData, []shared.TradeOrderData, []shared.TradeOrderData, error) {
