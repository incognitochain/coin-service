...
type TokenInfo struct {
	...
	PercentChange24hNew       string  `json:"PercentChange24hNew"`
	PercentChange24hNewDebug1 string  `json:"PercentChange24hNewDebug1"`
	PercentChange24hNewDebug2 string  `json:"PercentChange24hNewDebug2"`
